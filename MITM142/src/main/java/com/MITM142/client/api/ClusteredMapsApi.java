...
public class ClusteredMapsApi {
    private ApiClient localVarApiClient;

    public ClusteredMapsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ClusteredMapsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for clusteredAddToMap
     ...
     */
    public okhttp3.Call clusteredAddToMapCall(AddToMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = params;

        // create path and map variables
        String localVarPath = "/clustered-maps";
    ...
    private okhttp3.Call clusteredAddToMapValidateBeforeCall(AddToMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'params' is set
        if (params == null) {
            throw new ApiException("Missing the required parameter 'params' when calling clusteredAddToMap(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredAddToMapCall(params, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public String clusteredAddToMap(AddToMapParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<String> localVarResp = clusteredAddToMapWithHttpInfo(params, xAppUuid, xSecret, xToken);
     ...
     */
    public ApiResponse<String> clusteredAddToMapWithHttpInfo(AddToMapParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredAddToMapValidateBeforeCall(params, xAppUuid, xSecret, xToken, null);
     ...
     */
    public okhttp3.Call clusteredAddToMapAsync(AddToMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredAddToMapValidateBeforeCall(params, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredDelFromMap
     ...
     */
    public okhttp3.Call clusteredDelFromMapCall(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/clustered-maps/{table}/{key}/{objectKey}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredDelFromMapValidateBeforeCall(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'table' is set
        if (table == null) {
            throw new ApiException("Missing the required parameter 'table' when calling clusteredDelFromMap(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling clusteredDelFromMap(Async)");
        }
        
        // verify the required parameter 'objectKey' is set
        if (objectKey == null) {
            throw new ApiException("Missing the required parameter 'objectKey' when calling clusteredDelFromMap(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredDelFromMapCall(table, key, objectKey, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public String clusteredDelFromMap(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<String> localVarResp = clusteredDelFromMapWithHttpInfo(table, key, objectKey, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> clusteredDelFromMapWithHttpInfo(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredDelFromMapValidateBeforeCall(table, key, objectKey, xAppUuid, xSecret, xToken, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call clusteredDelFromMapAsync(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredDelFromMapValidateBeforeCall(table, key, objectKey, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredGetFromMap
     * @param table  (required)
     * @param key  (required)
     * @param objectKey  (required)
     * @param xAppUuid  (optional)
     ...
     */
    public okhttp3.Call clusteredGetFromMapCall(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/clustered-maps/get-from/{table}/{key}/{objectKey}"
            .replaceAll("\\{" + "table" + "\\}", localVarApiClient.escapeString(table.toString()))
            .replaceAll("\\{" + "key" + "\\}", localVarApiClient.escapeString(key.toString()))
            .replaceAll("\\{" + "objectKey" + "\\}", localVarApiClient.escapeString(objectKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredGetFromMapValidateBeforeCall(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'table' is set
        if (table == null) {
            throw new ApiException("Missing the required parameter 'table' when calling clusteredGetFromMap(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling clusteredGetFromMap(Async)");
        }
        
        // verify the required parameter 'objectKey' is set
        if (objectKey == null) {
            throw new ApiException("Missing the required parameter 'objectKey' when calling clusteredGetFromMap(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredGetFromMapCall(table, key, objectKey, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public String clusteredGetFromMap(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<String> localVarResp = clusteredGetFromMapWithHttpInfo(table, key, objectKey, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> clusteredGetFromMapWithHttpInfo(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredGetFromMapValidateBeforeCall(table, key, objectKey, xAppUuid, xSecret, xToken, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call clusteredGetFromMapAsync(String table, String key, String objectKey, String xAppUuid, String xSecret, String xToken, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredGetFromMapValidateBeforeCall(table, key, objectKey, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredGetMap
     * @param table  (required)
     * @param key  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     ...
     */
    public okhttp3.Call clusteredGetMapCall(String table, String key, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/clustered-maps/get-all/{table}/{key}"
            .replaceAll("\\{" + "table" + "\\}", localVarApiClient.escapeString(table.toString()))
            .replaceAll("\\{" + "key" + "\\}", localVarApiClient.escapeString(key.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredGetMapValidateBeforeCall(String table, String key, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'table' is set
        if (table == null) {
            throw new ApiException("Missing the required parameter 'table' when calling clusteredGetMap(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling clusteredGetMap(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredGetMapCall(table, key, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public Map<String, String> clusteredGetMap(String table, String key, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<Map<String, String>> localVarResp = clusteredGetMapWithHttpInfo(table, key, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, String>> clusteredGetMapWithHttpInfo(String table, String key, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredGetMapValidateBeforeCall(table, key, xAppUuid, xSecret, xToken, null);
     ...
     */
    public okhttp3.Call clusteredGetMapAsync(String table, String key, String xAppUuid, String xSecret, String xToken, final ApiCallback<Map<String, String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredGetMapValidateBeforeCall(table, key, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<Map<String, String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredGetMapPage
     * @param table  (required)
     * @param key  (required)
     ...
     */
    public okhttp3.Call clusteredGetMapPageCall(String table, String key, BigDecimal offset, BigDecimal limit, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/clustered-maps/get/{table}/{key}/{offset}/{limit}"
            .replaceAll("\\{" + "table" + "\\}", localVarApiClient.escapeString(table.toString()))
            .replaceAll("\\{" + "key" + "\\}", localVarApiClient.escapeString(key.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredGetMapPageValidateBeforeCall(String table, String key, BigDecimal offset, BigDecimal limit, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'table' is set
        if (table == null) {
            throw new ApiException("Missing the required parameter 'table' when calling clusteredGetMapPage(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling clusteredGetMapPage(Async)");
        }
        
        // verify the required parameter 'offset' is set
        if (offset == null) {
            throw new ApiException("Missing the required parameter 'offset' when calling clusteredGetMapPage(Async)");
        }
        
        // verify the required parameter 'limit' is set
        if (limit == null) {
            throw new ApiException("Missing the required parameter 'limit' when calling clusteredGetMapPage(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredGetMapPageCall(table, key, offset, limit, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public Map<String, String> clusteredGetMapPage(String table, String key, BigDecimal offset, BigDecimal limit, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<Map<String, String>> localVarResp = clusteredGetMapPageWithHttpInfo(table, key, offset, limit, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, String>> clusteredGetMapPageWithHttpInfo(String table, String key, BigDecimal offset, BigDecimal limit, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredGetMapPageValidateBeforeCall(table, key, offset, limit, xAppUuid, xSecret, xToken, null);
        Type localVarReturnType = new TypeToken<Map<String, String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call clusteredGetMapPageAsync(String table, String key, BigDecimal offset, BigDecimal limit, String xAppUuid, String xSecret, String xToken, final ApiCallback<Map<String, String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredGetMapPageValidateBeforeCall(table, key, offset, limit, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<Map<String, String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredGetMapsCount
     * @param table  (required)
     * @param key  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Number of elements in the map. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call clusteredGetMapsCountCall(String table, String key, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/clustered-maps/count/{table}/{key}"
            .replaceAll("\\{" + "table" + "\\}", localVarApiClient.escapeString(table.toString()))
            .replaceAll("\\{" + "key" + "\\}", localVarApiClient.escapeString(key.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredGetMapsCountValidateBeforeCall(String table, String key, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'table' is set
        if (table == null) {
            throw new ApiException("Missing the required parameter 'table' when calling clusteredGetMapsCount(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling clusteredGetMapsCount(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredGetMapsCountCall(table, key, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public Long clusteredGetMapsCount(String table, String key, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<Long> localVarResp = clusteredGetMapsCountWithHttpInfo(table, key, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Long> clusteredGetMapsCountWithHttpInfo(String table, String key, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredGetMapsCountValidateBeforeCall(table, key, xAppUuid, xSecret, xToken, null);
     ...
     */
    public okhttp3.Call clusteredGetMapsCountAsync(String table, String key, String xAppUuid, String xSecret, String xToken, final ApiCallback<Long> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredGetMapsCountValidateBeforeCall(table, key, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<Long>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredMultipleAddToMap
     * @param params  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     * @param xToken  (optional)
     ...
     */
    public okhttp3.Call clusteredMultipleAddToMapCall(MultipleAddToMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = params;

        // create path and map variables
        String localVarPath = "/clustered-maps/multiple";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredMultipleAddToMapValidateBeforeCall(MultipleAddToMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'params' is set
        if (params == null) {
            throw new ApiException("Missing the required parameter 'params' when calling clusteredMultipleAddToMap(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredMultipleAddToMapCall(params, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public String clusteredMultipleAddToMap(MultipleAddToMapParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<String> localVarResp = clusteredMultipleAddToMapWithHttpInfo(params, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> clusteredMultipleAddToMapWithHttpInfo(MultipleAddToMapParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredMultipleAddToMapValidateBeforeCall(params, xAppUuid, xSecret, xToken, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call clusteredMultipleAddToMapAsync(MultipleAddToMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredMultipleAddToMapValidateBeforeCall(params, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredMultipleDelFromMap
     * @param params  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     * @param xToken  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Number of deleted objects. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call clusteredMultipleDelFromMapCall(MultipleDelFromMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = params;

        // create path and map variables
        String localVarPath = "/clustered-maps/delete-multiple";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredMultipleDelFromMapValidateBeforeCall(MultipleDelFromMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'params' is set
        if (params == null) {
            throw new ApiException("Missing the required parameter 'params' when calling clusteredMultipleDelFromMap(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredMultipleDelFromMapCall(params, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public Long clusteredMultipleDelFromMap(MultipleDelFromMapParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<Long> localVarResp = clusteredMultipleDelFromMapWithHttpInfo(params, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Long> clusteredMultipleDelFromMapWithHttpInfo(MultipleDelFromMapParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredMultipleDelFromMapValidateBeforeCall(params, xAppUuid, xSecret, xToken, null);
        Type localVarReturnType = new TypeToken<Long>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call clusteredMultipleDelFromMapAsync(MultipleDelFromMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback<Long> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredMultipleDelFromMapValidateBeforeCall(params, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<Long>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredMultipleGetFromMap
     * @param params  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     * @param xToken  (optional)
     ...
     */
    public okhttp3.Call clusteredMultipleGetFromMapCall(MultipleGetFromMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = params;

        // create path and map variables
        String localVarPath = "/clustered-maps/get-multiple";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredMultipleGetFromMapValidateBeforeCall(MultipleGetFromMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'params' is set
        if (params == null) {
            throw new ApiException("Missing the required parameter 'params' when calling clusteredMultipleGetFromMap(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredMultipleGetFromMapCall(params, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public Map<String, String> clusteredMultipleGetFromMap(MultipleGetFromMapParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<Map<String, String>> localVarResp = clusteredMultipleGetFromMapWithHttpInfo(params, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, String>> clusteredMultipleGetFromMapWithHttpInfo(MultipleGetFromMapParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredMultipleGetFromMapValidateBeforeCall(params, xAppUuid, xSecret, xToken, null);
        Type localVarReturnType = new TypeToken<Map<String, String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call clusteredMultipleGetFromMapAsync(MultipleGetFromMapParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback<Map<String, String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredMultipleGetFromMapValidateBeforeCall(params, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<Map<String, String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for clusteredScanMapKeys
     * @param params  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     * @param xToken  (optional)
     ...
     */
    public okhttp3.Call clusteredScanMapKeysCall(ClusteredScanKeysParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = params;

        // create path and map variables
        String localVarPath = "/clustered-maps/scan";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clusteredScanMapKeysValidateBeforeCall(ClusteredScanKeysParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'params' is set
        if (params == null) {
            throw new ApiException("Missing the required parameter 'params' when calling clusteredScanMapKeys(Async)");
        }
        

        okhttp3.Call localVarCall = clusteredScanMapKeysCall(params, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
     ...
     */
    public ClusteredScanData clusteredScanMapKeys(ClusteredScanKeysParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<ClusteredScanData> localVarResp = clusteredScanMapKeysWithHttpInfo(params, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ClusteredScanData> clusteredScanMapKeysWithHttpInfo(ClusteredScanKeysParams params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = clusteredScanMapKeysValidateBeforeCall(params, xAppUuid, xSecret, xToken, null);
     ...
     */
    public okhttp3.Call clusteredScanMapKeysAsync(ClusteredScanKeysParams params, String xAppUuid, String xSecret, String xToken, final ApiCallback<ClusteredScanData> _callback) throws ApiException {

        okhttp3.Call localVarCall = clusteredScanMapKeysValidateBeforeCall(params, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<ClusteredScanData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
