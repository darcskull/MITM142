...
public class FullTextSearchApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Flag indicating whether delete operation was succesful or not. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteIndexCall(String index, String limit, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/search/delete-index/{index}/{limit}"
    ...
    private okhttp3.Call deleteIndexValidateBeforeCall(String index, String limit, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'index' is set
        if (index == null) {
            throw new ApiException("Missing the required parameter 'index' when calling deleteIndex(Async)");
        }
        
        // verify the required parameter 'limit' is set
        if (limit == null) {
            throw new ApiException("Missing the required parameter 'limit' when calling deleteIndex(Async)");
        }
        

        okhttp3.Call localVarCall = deleteIndexCall(index, limit, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
    ...
    /**
     * 
     * Delete existing index from the storage.&lt;br&gt;&lt;br&gt; &lt;b&gt;Complexity&lt;/b&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;: O(1) - a background job will do the real deletion.&lt;br&gt; 
     * @param index  (required)
     * @param limit  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     ...
     */
    public Boolean deleteIndex(String index, String limit, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<Boolean> localVarResp = deleteIndexWithHttpInfo(index, limit, xAppUuid, xSecret, xToken);
     ...
     */
    public ApiResponse<Boolean> deleteIndexWithHttpInfo(String index, String limit, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = deleteIndexValidateBeforeCall(index, limit, xAppUuid, xSecret, xToken, null);
     ...
     */
    public okhttp3.Call deleteIndexAsync(String index, String limit, String xAppUuid, String xSecret, String xToken, final ApiCallback<Boolean> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteIndexValidateBeforeCall(index, limit, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for putToIndex
     * @param index  (required)
     ...
     */
    public okhttp3.Call putToIndexCall(String index, IndexData params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = params;

        // create path and map variables
        String localVarPath = "/search/put-to-index/{index}"
            .replaceAll("\\{" + "index" + "\\}", localVarApiClient.escapeString(index.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putToIndexValidateBeforeCall(String index, IndexData params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'index' is set
        if (index == null) {
            throw new ApiException("Missing the required parameter 'index' when calling putToIndex(Async)");
        }
        
        // verify the required parameter 'params' is set
        if (params == null) {
            throw new ApiException("Missing the required parameter 'params' when calling putToIndex(Async)");
        }
        

        okhttp3.Call localVarCall = putToIndexCall(index, params, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
    ...
    /**
     * 
     * Index documents using regex trigrams and bm25 search algorithms.&lt;br&gt;&lt;br&gt; &lt;b&gt;Complexity&lt;/b&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;: O(M*log(N)) where M is the total number of tokens and N is the already stored number of tokens in the storage.&lt;br&gt; &lt;b&gt;Param Fields Used&lt;/b&gt;&amp;nbsp;: All      
     * @param index  (required)
     * @param params  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     ...
     */
    public String putToIndex(String index, IndexData params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<String> localVarResp = putToIndexWithHttpInfo(index, params, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> putToIndexWithHttpInfo(String index, IndexData params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = putToIndexValidateBeforeCall(index, params, xAppUuid, xSecret, xToken, null);
     ...
     */
    public okhttp3.Call putToIndexAsync(String index, IndexData params, String xAppUuid, String xSecret, String xToken, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = putToIndexValidateBeforeCall(index, params, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> List with document ids found by the chosen algorithm. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call searchIndexCall(String index, SearchQuery params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = params;

        // create path and map variables
        String localVarPath = "/search/search-index/{index}"
            .replaceAll("\\{" + "index" + "\\}", localVarApiClient.escapeString(index.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchIndexValidateBeforeCall(String index, SearchQuery params, String xAppUuid, String xSecret, String xToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'index' is set
        if (index == null) {
            throw new ApiException("Missing the required parameter 'index' when calling searchIndex(Async)");
        }
        
        // verify the required parameter 'params' is set
        if (params == null) {
            throw new ApiException("Missing the required parameter 'params' when calling searchIndex(Async)");
        }
        

        okhttp3.Call localVarCall = searchIndexCall(index, params, xAppUuid, xSecret, xToken, _callback);
        return localVarCall;
    ...
    /**
     * 
     * Search in documents using regex trigrams, bm25 and phrases search algorithms.&lt;br&gt;&lt;br&gt; &lt;b&gt;Complexity&lt;/b&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;: Depends on the query but usually O(M*N*log(N)) where M is number of keywords and N is arround 10000 elements.&lt;br&gt; &lt;b&gt;Param Fields Used&lt;/b&gt;&amp;nbsp;: All      
     * @param index  (required)
     * @param params  (required)
     * @param xAppUuid  (optional)
     * @param xSecret  (optional)
     ...
     */
    public List<String> searchIndex(String index, SearchQuery params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        ApiResponse<List<String>> localVarResp = searchIndexWithHttpInfo(index, params, xAppUuid, xSecret, xToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<String>> searchIndexWithHttpInfo(String index, SearchQuery params, String xAppUuid, String xSecret, String xToken) throws ApiException {
        okhttp3.Call localVarCall = searchIndexValidateBeforeCall(index, params, xAppUuid, xSecret, xToken, null);
     ...
     */
    public okhttp3.Call searchIndexAsync(String index, SearchQuery params, String xAppUuid, String xSecret, String xToken, final ApiCallback<List<String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchIndexValidateBeforeCall(index, params, xAppUuid, xSecret, xToken, _callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
