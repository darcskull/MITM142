...
public class AddRecordsParams {
  public static final String SERIALIZED_NAME_RECORDS = "records";
  @SerializedName(SERIALIZED_NAME_RECORDS)
  private List<java.lang.Record> records = new ArrayList<java.lang.Record>();
  ...
  public AddRecordsParams records(List<java.lang.Record> records) {
    
    this.records = records;
    return this;
  }

  public AddRecordsParams addRecordsItem(java.lang.Record recordsItem) {
   ...
   * @return records
  **/
  @ApiModelProperty(required = true, value = "List of records to add.")
  ...
  public AddRecordsParams clustered(Boolean clustered) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddRecordsParams addRecordsParams = (AddRecordsParams) o;
    return Objects.equals(this.records, addRecordsParams.records) &&
        Objects.equals(this.clustered, addRecordsParams.clustered);
  }

  @Override
  public int hashCode() {
    return Objects.hash(records, clustered);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddRecordsParams {\n");
