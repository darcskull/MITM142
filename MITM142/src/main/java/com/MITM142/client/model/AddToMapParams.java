...
public class AddToMapParams {
  ...
  public AddToMapParams table(String table) {
  ...
  **/
  ...
  public AddToMapParams key(String key) {
  ...
  **/
  ...
  public AddToMapParams objectKey(String objectKey) {
   ...
   /**
   * Object key of the data.
   * @return objectKey
  **/
  @ApiModelProperty(required = true, value = "Object key of the data.")
  ...
  public AddToMapParams _object(String _object) {
   ...
   * @return _object
  **/
  @ApiModelProperty(required = true, value = "Value of the data.")
  ...
  public boolean equals(Object o) {
    ...
    AddToMapParams addToMapParams = (AddToMapParams) o;
    return Objects.equals(this.table, addToMapParams.table) &&
        Objects.equals(this.key, addToMapParams.key) &&
        Objects.equals(this.objectKey, addToMapParams.objectKey) &&
        Objects.equals(this._object, addToMapParams._object);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, key, objectKey, _object);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddToMapParams {\n");
