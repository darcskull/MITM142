...
/**
 * Response object for non-200 HTTP status code.
 */
@ApiModel(description = "Response object for non-200 HTTP status code.")
...
public class ApiErr {
  ...
  public ApiErr stacktrace(String stacktrace) {
   ...
   /**
   * Stacktrace with the error&#39;s origin.
   * @return stacktrace
  **/
  @ApiModelProperty(required = true, value = "Stacktrace with the error's origin.")
  ...
  public ApiErr message(String message) {
   ...
   * @return message
  **/
  @ApiModelProperty(required = true, value = "A descriptive message explaining the nature of the error.")
  ...
  public boolean equals(Object o) {
    ...
    ApiErr apiErr = (ApiErr) o;
    return Objects.equals(this.stacktrace, apiErr.stacktrace) &&
        Objects.equals(this.message, apiErr.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stacktrace, message);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiErr {\n");
