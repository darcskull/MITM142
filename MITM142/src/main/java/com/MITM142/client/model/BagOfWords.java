...
/**
 * Object used for storing bag of words in given language. Used by the full text search storage. 
 */
@ApiModel(description = "Object used for storing bag of words in given language. Used by the full text search storage. ")
...
public class BagOfWords {
  ...
  public BagOfWords words(Map<String, Long> words) {
    
    this.words = words;
    return this;
  }

  public BagOfWords putWordsItem(String key, Long wordsItem) {
    this.words.put(key, wordsItem);
    return this;
  }

   /**
   * map[string]int64, where keys are words and values are the number of occurences.
   * @return words
  **/
  @ApiModelProperty(required = true, value = "map[string]int64, where keys are words and values are the number of occurences.")
  ...
  public BagOfWords language(String language) {
   ...
   /**
   * Language of the words in two letters ISO 639 format. eg. English -&gt; en.
   * @return language
  **/
  @ApiModelProperty(required = true, value = "Language of the words in two letters ISO 639 format. eg. English -> en.")
  ...
  public boolean equals(Object o) {
    ...
    BagOfWords bagOfWords = (BagOfWords) o;
    return Objects.equals(this.words, bagOfWords.words) &&
        Objects.equals(this.language, bagOfWords.language);
  }

  @Override
  public int hashCode() {
    return Objects.hash(words, language);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BagOfWords {\n");
