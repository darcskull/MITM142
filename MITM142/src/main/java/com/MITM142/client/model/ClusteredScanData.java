...
public class ClusteredScanData {
  ...
  public ClusteredScanData keys(List<String> keys) {
    
    this.keys = keys;
    return this;
  }

  public ClusteredScanData addKeysItem(String keysItem) {
  ...
  **/
  ...
  public ClusteredScanData cursor(String cursor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ClusteredScanData clusteredScanData = (ClusteredScanData) o;
    return Objects.equals(this.keys, clusteredScanData.keys) &&
        Objects.equals(this.cursor, clusteredScanData.cursor);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusteredScanData {\n");
