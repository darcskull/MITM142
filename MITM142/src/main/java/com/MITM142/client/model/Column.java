...
/**
 * Object representing a column in SQL storage. Used in multi-index storage. 
 */
@ApiModel(description = "Object representing a column in SQL storage. Used in multi-index storage. ")
...
public class Column {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Name of the column.")
  ...
  public Column type(String type) {
   ...
   /**
   * Type of the column. Supported types are - string, int64 and float64
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Type of the column. Supported types are - string, int64 and float64")
  ...
  public Column value(String value) {
   ...
   /**
   * Stored value in this column instance.
   * @return value
  **/
  @ApiModelProperty(required = true, value = "Stored value in this column instance.")
