...
/**
 * Object used for storing documents. Used by the full text search storage. 
 */
@ApiModel(description = "Object used for storing documents. Used by the full text search storage. ")
...
public class Document {
  ...
  public Document id(Long id) {
   ...
   /**
   * User-asigned distinct id of the document.
   * @return id
  **/
  @ApiModelProperty(required = true, value = "User-asigned distinct id of the document.")
  ...
  public Document text(String text) {
   ...
   /**
   * Raw text of the document. Indexed by full text search storage.
   * @return text
  **/
  @ApiModelProperty(required = true, value = "Raw text of the document. Indexed by full text search storage.")
