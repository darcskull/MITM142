...
/**
 * Object used for configuring the engine indexing mode per document. Used by the full text search storage. 
 */
@ApiModel(description = "Object used for configuring the engine indexing mode per document. Used by the full text search storage. ")
...
public class DocumentConfiguration {
  ...
  public static final String SERIALIZED_NAME_BM25_TOKENS = "BM25Tokens";
  @SerializedName(SERIALIZED_NAME_BM25_TOKENS)
  private BagOfWords bm25Tokens;

  public static final String SERIALIZED_NAME_BM25_INDEX_MODE = "BM25IndexMode";
  @SerializedName(SERIALIZED_NAME_BM25_INDEX_MODE)
  private String bm25IndexMode;

  public static final String SERIALIZED_NAME_REGEX_TOKENS = "regexTokens";
  @SerializedName(SERIALIZED_NAME_REGEX_TOKENS)
  private BagOfWords regexTokens;

  public static final String SERIALIZED_NAME_REGEX_INDEX_MODE = "regexIndexMode";
  @SerializedName(SERIALIZED_NAME_REGEX_INDEX_MODE)
  private String regexIndexMode;

  public static final String SERIALIZED_NAME_GENERATE_PHRASES_FROM_DOCUMENT = "generatePhrasesFromDocument";
  @SerializedName(SERIALIZED_NAME_GENERATE_PHRASES_FROM_DOCUMENT)
  private Boolean generatePhrasesFromDocument;


  public DocumentConfiguration data(Document data) {
  ...
  **/
  ...
  public DocumentConfiguration language(String language) {
   ...
   /**
   * Language of the document in two letters ISO 639 format. Used for (stemming, soundex, etc) optimizations of the search index.
   * @return language
  **/
  @ApiModelProperty(required = true, value = "Language of the document in two letters ISO 639 format. Used for (stemming, soundex, etc) optimizations of the search index.")
  ...
  public DocumentConfiguration bm25Tokens(BagOfWords bm25Tokens) {
  ...
  **/
  ...
  public BagOfWords getBm25Tokens() {
    return bm25Tokens;
  }


  public void setBm25Tokens(BagOfWords bm25Tokens) {
    this.bm25Tokens = bm25Tokens;
  }


  public DocumentConfiguration bm25IndexMode(String bm25IndexMode) {
    
    this.bm25IndexMode = bm25IndexMode;
    return this;
  }

   /**
   * Index mode for bm25 search. Supported values are - \&quot;auto\&quot;, \&quot;user_provided\&quot;, \&quot;both\&quot;. \&quot;auto\&quot; mode will automatically index the content stored in the Document object. \&quot;user_provided\&quot; will index only the data provided by BM25BagOfWords. \&quot;both\&quot; will index both.
   * @return bm25IndexMode
  **/
  @ApiModelProperty(required = true, value = "Index mode for bm25 search. Supported values are - \"auto\", \"user_provided\", \"both\". \"auto\" mode will automatically index the content stored in the Document object. \"user_provided\" will index only the data provided by BM25BagOfWords. \"both\" will index both.")

  public String getBm25IndexMode() {
    return bm25IndexMode;
  }


  public void setBm25IndexMode(String bm25IndexMode) {
    this.bm25IndexMode = bm25IndexMode;
  }


  public DocumentConfiguration regexTokens(BagOfWords regexTokens) {
  ...
  **/
  ...
  public BagOfWords getRegexTokens() {
    return regexTokens;
  }


  public void setRegexTokens(BagOfWords regexTokens) {
    this.regexTokens = regexTokens;
  }


  public DocumentConfiguration regexIndexMode(String regexIndexMode) {
    
    this.regexIndexMode = regexIndexMode;
    return this;
  }

   /**
   * Index mode for regex search. Supported values are - \&quot;auto\&quot;, \&quot;user_provided\&quot;, \&quot;both\&quot;. \&quot;auto\&quot; mode will automatically index the content stored in the Document object. \&quot;user_provided\&quot; will index only the data provided by BM25BagOfWords. \&quot;both\&quot; will index both.
   * @return regexIndexMode
  **/
  @ApiModelProperty(required = true, value = "Index mode for regex search. Supported values are - \"auto\", \"user_provided\", \"both\". \"auto\" mode will automatically index the content stored in the Document object. \"user_provided\" will index only the data provided by BM25BagOfWords. \"both\" will index both.")

  public String getRegexIndexMode() {
    return regexIndexMode;
  }


  public void setRegexIndexMode(String regexIndexMode) {
    this.regexIndexMode = regexIndexMode;
  }


  public DocumentConfiguration generatePhrasesFromDocument(Boolean generatePhrasesFromDocument) {
    
    this.generatePhrasesFromDocument = generatePhrasesFromDocument;
    return this;
  }

   /**
   * Flag indicating whether the storage should try creating and indexing two and three words long phrases from document. eg. the text \&quot;I love software engineering problems\&quot; will result in the following phrases \&quot;i love software\&quot;, \&quot;love sofware engineering\&quot;, \&quot;love software\&quot; and etc.
   * @return generatePhrasesFromDocument
  **/
  @ApiModelProperty(required = true, value = "Flag indicating whether the storage should try creating and indexing two and three words long phrases from document. eg. the text \"I love software engineering problems\" will result in the following phrases \"i love software\", \"love sofware engineering\", \"love software\" and etc.")

  public Boolean getGeneratePhrasesFromDocument() {
    return generatePhrasesFromDocument;
  }


  public void setGeneratePhrasesFromDocument(Boolean generatePhrasesFromDocument) {
    this.generatePhrasesFromDocument = generatePhrasesFromDocument;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentConfiguration documentConfiguration = (DocumentConfiguration) o;
    return Objects.equals(this.data, documentConfiguration.data) &&
        Objects.equals(this.language, documentConfiguration.language) &&
        Objects.equals(this.bm25Tokens, documentConfiguration.bm25Tokens) &&
        Objects.equals(this.bm25IndexMode, documentConfiguration.bm25IndexMode) &&
        Objects.equals(this.regexTokens, documentConfiguration.regexTokens) &&
        Objects.equals(this.regexIndexMode, documentConfiguration.regexIndexMode) &&
        Objects.equals(this.generatePhrasesFromDocument, documentConfiguration.generatePhrasesFromDocument);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, language, bm25Tokens, bm25IndexMode, regexTokens, regexIndexMode, generatePhrasesFromDocument);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DocumentConfiguration {\n");
    sb.append("    data: ").append(toIndentedString(data)).append("\n");
    sb.append("    language: ").append(toIndentedString(language)).append("\n");
    sb.append("    bm25Tokens: ").append(toIndentedString(bm25Tokens)).append("\n");
    sb.append("    bm25IndexMode: ").append(toIndentedString(bm25IndexMode)).append("\n");
    sb.append("    regexTokens: ").append(toIndentedString(regexTokens)).append("\n");
    sb.append("    regexIndexMode: ").append(toIndentedString(regexIndexMode)).append("\n");
    sb.append("    generatePhrasesFromDocument: ").append(toIndentedString(generatePhrasesFromDocument)).append("\n");
    sb.append("}");
    return sb.toString();
  }
