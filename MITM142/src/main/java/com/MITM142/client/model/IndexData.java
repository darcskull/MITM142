...
/**
 * Object used for batch indexing multiple documents. Used by the full text search storage. 
 */
@ApiModel(description = "Object used for batch indexing multiple documents. Used by the full text search storage. ")
...
public class IndexData {
  public static final String SERIALIZED_NAME_DOCUMENT_CONFIGURATIONS = "documentConfigurations";
  @SerializedName(SERIALIZED_NAME_DOCUMENT_CONFIGURATIONS)
  private List<DocumentConfiguration> documentConfigurations = new ArrayList<DocumentConfiguration>();
  ...
  public IndexData documentConfigurations(List<DocumentConfiguration> documentConfigurations) {
    
    this.documentConfigurations = documentConfigurations;
    return this;
  }

  public IndexData addDocumentConfigurationsItem(DocumentConfiguration documentConfigurationsItem) {
    this.documentConfigurations.add(documentConfigurationsItem);
    return this;
  }

   /**
   * Array of configurations and their respective documents to index.
   * @return documentConfigurations
  **/
  @ApiModelProperty(required = true, value = "Array of configurations and their respective documents to index.")

  public List<DocumentConfiguration> getDocumentConfigurations() {
    return documentConfigurations;
  }


  public void setDocumentConfigurations(List<DocumentConfiguration> documentConfigurations) {
    this.documentConfigurations = documentConfigurations;
  }


  public IndexData phrases(List<String> phrases) {
    
    this.phrases = phrases;
    return this;
  }

  public IndexData addPhrasesItem(String phrasesItem) {
    this.phrases.add(phrasesItem);
    return this;
  }

   /**
   * Array of phrases to index.
   * @return phrases
  **/
  @ApiModelProperty(required = true, value = "Array of phrases to index.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.documentConfigurations, indexData.documentConfigurations) &&
        Objects.equals(this.phrases, indexData.phrases);
  }

  @Override
  public int hashCode() {
    return Objects.hash(documentConfigurations, phrases);
  }
  ...
  public String toString() {
    ...
    sb.append("    documentConfigurations: ").append(toIndentedString(documentConfigurations)).append("\n");
