...
/**
 * Object representing a key entry in NoSQL storage. {{key}} --&gt; {{value}} equivivalent is {{table}}/{{key}} --&gt; {{value}}     
 */
@ApiModel(description = "Object representing a key entry in NoSQL storage. {{key}} --> {{value}} equivivalent is {{table}}/{{key}} --> {{value}}     ")
...
public class KeysEntry {
  ...
  public KeysEntry table(String table) {
   ...
   * @return table
  **/
  @ApiModelProperty(required = true, value = "Table of the entry.")
  ...
  public KeysEntry key(String key) {
   ...
   * @return key
  **/
  @ApiModelProperty(required = true, value = "Key of the entry.")
  ...
  public KeysEntry value(String value) {
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "Value of the entry.")
  ...
  public KeysEntry ttl(Long ttl) {
   ...
   /**
   * Time to live of the entry in UNIX epoch milliseconds.
   * @return ttl
  **/
  @ApiModelProperty(required = true, value = "Time to live of the entry in UNIX epoch milliseconds.")
  ...
  public KeysEntry deleted(Boolean deleted) {
   ...
   /**
   * Flag indicating whether the entry is deleted or not.
   * @return deleted
  **/
  @ApiModelProperty(required = true, value = "Flag indicating whether the entry is deleted or not.")
  ...
  public boolean equals(Object o) {
    ...
    KeysEntry keysEntry = (KeysEntry) o;
    return Objects.equals(this.table, keysEntry.table) &&
        Objects.equals(this.key, keysEntry.key) &&
        Objects.equals(this.value, keysEntry.value) &&
        Objects.equals(this.ttl, keysEntry.ttl) &&
        Objects.equals(this.deleted, keysEntry.deleted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, key, value, ttl, deleted);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KeysEntry {\n");
