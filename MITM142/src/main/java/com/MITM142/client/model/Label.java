...
/**
 * Object representing label for storing timeseries. Used in timeseries storage. 
 */
@ApiModel(description = "Object representing label for storing timeseries. Used in timeseries storage. ")
...
public class Label {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Name of the label.")
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "Value of the label.")
