...
public class LocksRequestParams {
  ...
  public LocksRequestParams table(String table) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Table to use for operation.")
  ...
  public LocksRequestParams key(String key) {
   ...
   /**
   * Key to use for operation.
   * @return key
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Key to use for operation.")
  ...
  public LocksRequestParams token(String token) {
   ...
   /**
   * Token to use for operation. Used to identify the lock across all nodes.
   * @return token
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Token to use for operation. Used to identify the lock across all nodes.")
  ...
  public LocksRequestParams duration(Long duration) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Time to live of the lock in milliseconds.")
  ...
  public boolean equals(Object o) {
    ...
    LocksRequestParams locksRequestParams = (LocksRequestParams) o;
    return Objects.equals(this.table, locksRequestParams.table) &&
        Objects.equals(this.key, locksRequestParams.key) &&
        Objects.equals(this.token, locksRequestParams.token) &&
        Objects.equals(this.duration, locksRequestParams.duration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, key, token, duration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LocksRequestParams {\n");
