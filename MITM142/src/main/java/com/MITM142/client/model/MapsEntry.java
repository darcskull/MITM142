...
/**
 * Object representing a map entry in NoSQL storage. {{key}} {{objectKey}} --&gt; {{value}} equivivalent is {{table}}/{{key}} {{objectKey}} --&gt; {{value}}     
 */
@ApiModel(description = "Object representing a map entry in NoSQL storage. {{key}} {{objectKey}} --> {{value}} equivivalent is {{table}}/{{key}} {{objectKey}} --> {{value}}     ")
...
public class MapsEntry {
  ...
  public MapsEntry table(String table) {
  ...
  **/
  ...
  public MapsEntry key(String key) {
  ...
  **/
  ...
  public MapsEntry objectKey(String objectKey) {
   ...
   * @return objectKey
  **/
  @ApiModelProperty(required = true, value = "Object key of the entry.")
  ...
  public MapsEntry value(String value) {
  ...
  **/
  ...
  public MapsEntry deleted(Boolean deleted) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MapsEntry mapsEntry = (MapsEntry) o;
    return Objects.equals(this.table, mapsEntry.table) &&
        Objects.equals(this.key, mapsEntry.key) &&
        Objects.equals(this.objectKey, mapsEntry.objectKey) &&
        Objects.equals(this.value, mapsEntry.value) &&
        Objects.equals(this.deleted, mapsEntry.deleted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, key, objectKey, value, deleted);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MapsEntry {\n");
