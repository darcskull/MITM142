...
/**
 * Object used for matching and filtering timeseries entries. Used in timeseries storage. 
 */
@ApiModel(description = "Object used for matching and filtering timeseries entries. Used in timeseries storage. ")
...
public class Matcher {
  ...
  public Matcher label(Label label) {
  ...
  **/
  ...
  public Matcher type(String type) {
   ...
   /**
   * Type of the matching algorithm. Currently supported are - EQ(equals), NEQ(not equals), RE(regex match), NRE(regex not match)
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Type of the matching algorithm. Currently supported are - EQ(equals), NEQ(not equals), RE(regex match), NRE(regex not match)")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, matcher.label) &&
