...
public class MultiIndexRangeParams {
  ...
  public MultiIndexRangeParams range(Range range) {
  ...
  **/
  ...
  public MultiIndexRangeParams clustered(Boolean clustered) {
   ...
   /**
   * Flag indicating whether to use or not the clustered version of the Multi Index or not.
   * @return clustered
  **/
  @ApiModelProperty(required = true, value = "Flag indicating whether to use or not the clustered version of the Multi Index or not.")
  ...
  public MultiIndexRangeParams offset(Long offset) {
  ...
  **/
  ...
  public MultiIndexRangeParams limit(Long limit) {
   ...
   /**
   * Number of records to get during next iteration.
   * @return limit
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of records to get during next iteration.")
  ...
  public boolean equals(Object o) {
    ...
    MultiIndexRangeParams multiIndexRangeParams = (MultiIndexRangeParams) o;
    return Objects.equals(this.range, multiIndexRangeParams.range) &&
        Objects.equals(this.clustered, multiIndexRangeParams.clustered) &&
        Objects.equals(this.offset, multiIndexRangeParams.offset) &&
        Objects.equals(this.limit, multiIndexRangeParams.limit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(range, clustered, offset, limit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MultiIndexRangeParams {\n");
