...
public class MultipleAddToMapParams {
  public static final String SERIALIZED_NAME_BATCH = "batch";
  @SerializedName(SERIALIZED_NAME_BATCH)
  private List<MapsEntry> batch = new ArrayList<MapsEntry>();


  public MultipleAddToMapParams batch(List<MapsEntry> batch) {
    
    this.batch = batch;
    return this;
  }

  public MultipleAddToMapParams addBatchItem(MapsEntry batchItem) {
  ...
  **/
  ...
  public List<MapsEntry> getBatch() {
    return batch;
  }


  public void setBatch(List<MapsEntry> batch) {
    this.batch = batch;
  }
  ...
  public boolean equals(Object o) {
    ...
    MultipleAddToMapParams multipleAddToMapParams = (MultipleAddToMapParams) o;
    return Objects.equals(this.batch, multipleAddToMapParams.batch);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultipleAddToMapParams {\n");
