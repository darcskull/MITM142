...
public class MultipleAddToSortedSetParams {
  public static final String SERIALIZED_NAME_BATCH = "batch";
  @SerializedName(SERIALIZED_NAME_BATCH)
  private List<SetsEntry> batch = new ArrayList<SetsEntry>();


  public MultipleAddToSortedSetParams batch(List<SetsEntry> batch) {
    
    this.batch = batch;
    return this;
  }

  public MultipleAddToSortedSetParams addBatchItem(SetsEntry batchItem) {
   ...
   * @return batch
  **/
  @ApiModelProperty(required = true, value = "Array of entries to insert.")

  public List<SetsEntry> getBatch() {
    return batch;
  }


  public void setBatch(List<SetsEntry> batch) {
    this.batch = batch;
  }
  ...
  public boolean equals(Object o) {
    ...
    MultipleAddToSortedSetParams multipleAddToSortedSetParams = (MultipleAddToSortedSetParams) o;
    return Objects.equals(this.batch, multipleAddToSortedSetParams.batch);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultipleAddToSortedSetParams {\n");
