...
/**
 * MultipleAtomicCountersRequestParams
 */
...
public class MultipleAtomicCountersRequestParams {
  ...
  public MultipleAtomicCountersRequestParams table(String table) {
   ...
   /**
   * Table to use for operation.
   * @return table
  **/
  @ApiModelProperty(required = true, value = "Table to use for operation.")
  ...
  public MultipleAtomicCountersRequestParams keys(List<String> keys) {
    
    this.keys = keys;
    return this;
  }

  public MultipleAtomicCountersRequestParams addKeysItem(String keysItem) {
    this.keys.add(keysItem);
    return this;
  }

   /**
   * Array of keys to use for operation.
   * @return keys
  **/
  @ApiModelProperty(required = true, value = "Array of keys to use for operation.")
  ...
  public MultipleAtomicCountersRequestParams amount(Long amount) {
   ...
   /**
   * The amount with which the counters are changed. Could be positive or negative.
   * @return amount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount with which the counters are changed. Could be positive or negative.")
  ...
  public boolean equals(Object o) {
    ...
    MultipleAtomicCountersRequestParams multipleAtomicCountersRequestParams = (MultipleAtomicCountersRequestParams) o;
    return Objects.equals(this.table, multipleAtomicCountersRequestParams.table) &&
        Objects.equals(this.keys, multipleAtomicCountersRequestParams.keys) &&
        Objects.equals(this.amount, multipleAtomicCountersRequestParams.amount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, keys, amount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MultipleAtomicCountersRequestParams {\n");
