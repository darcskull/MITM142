...
public class MultipleDelKeyParams {
  ...
  public MultipleDelKeyParams table(String table) {
   ...
   /**
   * Array of tables to delete.
   * @return table
  **/
  @ApiModelProperty(required = true, value = "Array of tables to delete.")
  ...
  public MultipleDelKeyParams keys(List<String> keys) {
    
    this.keys = keys;
    return this;
  }

  public MultipleDelKeyParams addKeysItem(String keysItem) {
   ...
   * @return keys
  **/
  @ApiModelProperty(required = true, value = "Array of keys to delete.")
  ...
  public boolean equals(Object o) {
    ...
    MultipleDelKeyParams multipleDelKeyParams = (MultipleDelKeyParams) o;
    return Objects.equals(this.table, multipleDelKeyParams.table) &&
        Objects.equals(this.keys, multipleDelKeyParams.keys);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, keys);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MultipleDelKeyParams {\n");
