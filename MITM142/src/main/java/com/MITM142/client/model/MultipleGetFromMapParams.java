...
public class MultipleGetFromMapParams {
  ...
  public static final String SERIALIZED_NAME_OBJECT_KEYS = "objectKeys";
  @SerializedName(SERIALIZED_NAME_OBJECT_KEYS)
  private List<String> objectKeys = new ArrayList<String>();


  public MultipleGetFromMapParams table(String table) {
   ...
   * @return table
  **/
  @ApiModelProperty(required = true, value = "Table to get from.")
  ...
  public MultipleGetFromMapParams key(String key) {
   ...
   * @return key
  **/
  @ApiModelProperty(required = true, value = "Key to get from.")
  ...
  public MultipleGetFromMapParams objectKeys(List<String> objectKeys) {
    
    this.objectKeys = objectKeys;
    return this;
  }

  public MultipleGetFromMapParams addObjectKeysItem(String objectKeysItem) {
    this.objectKeys.add(objectKeysItem);
    return this;
  }

   /**
   * Array of object keys to get.
   * @return objectKeys
  **/
  @ApiModelProperty(required = true, value = "Array of object keys to get.")
  ...
  public boolean equals(Object o) {
    ...
    MultipleGetFromMapParams multipleGetFromMapParams = (MultipleGetFromMapParams) o;
    return Objects.equals(this.table, multipleGetFromMapParams.table) &&
        Objects.equals(this.key, multipleGetFromMapParams.key) &&
        Objects.equals(this.objectKeys, multipleGetFromMapParams.objectKeys);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, key, objectKeys);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MultipleGetFromMapParams {\n");
