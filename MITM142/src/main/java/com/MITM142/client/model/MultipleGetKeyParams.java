...
public class MultipleGetKeyParams {
  ...
  public MultipleGetKeyParams table(String table) {
   ...
   /**
   * Array of tables to get.
   * @return table
  **/
  @ApiModelProperty(required = true, value = "Array of tables to get.")
  ...
  public MultipleGetKeyParams keys(List<String> keys) {
    
    this.keys = keys;
    return this;
  }

  public MultipleGetKeyParams addKeysItem(String keysItem) {
   ...
   * @return keys
  **/
  @ApiModelProperty(required = true, value = "Array of keys to get.")
  ...
  public boolean equals(Object o) {
    ...
    MultipleGetKeyParams multipleGetKeyParams = (MultipleGetKeyParams) o;
    return Objects.equals(this.table, multipleGetKeyParams.table) &&
        Objects.equals(this.keys, multipleGetKeyParams.keys);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultipleGetKeyParams {\n");
