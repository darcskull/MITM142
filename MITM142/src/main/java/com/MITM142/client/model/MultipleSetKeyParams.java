...
public class MultipleSetKeyParams {
  public static final String SERIALIZED_NAME_BATCH = "batch";
  @SerializedName(SERIALIZED_NAME_BATCH)
  private List<KeysEntry> batch = new ArrayList<KeysEntry>();


  public MultipleSetKeyParams batch(List<KeysEntry> batch) {
    
    this.batch = batch;
    return this;
  }

  public MultipleSetKeyParams addBatchItem(KeysEntry batchItem) {
  ...
  **/
  ...
  public List<KeysEntry> getBatch() {
    return batch;
  }


  public void setBatch(List<KeysEntry> batch) {
    this.batch = batch;
  }
  ...
  public boolean equals(Object o) {
    ...
    MultipleSetKeyParams multipleSetKeyParams = (MultipleSetKeyParams) o;
    return Objects.equals(this.batch, multipleSetKeyParams.batch);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultipleSetKeyParams {\n");
