...
/**
 * Object used for storing file meta information. Used by the filestorage. 
 */
@ApiModel(description = "Object used for storing file meta information. Used by the filestorage. ")
...
public class ObjectInfo {
  ...
  public ObjectInfo etag(String etag) {
   ...
   * @return etag
  **/
  @ApiModelProperty(required = true, value = "Etag of the file.")
  ...
  **/
  ...
  public ObjectInfo lastModified(Long lastModified) {
   ...
   /**
   * Last modified of the file in UNIX epoch milliseconds.
   * @return lastModified
  **/
  @ApiModelProperty(required = true, value = "Last modified of the file in UNIX epoch milliseconds.")
   ...
   * @return size
  **/
  @ApiModelProperty(required = true, value = "Size of the file.")
  ...
  public ObjectInfo contentType(String contentType) {
   ...
   * @return contentType
  **/
  @ApiModelProperty(required = true, value = "Content type of the file.")
  ...
  public ObjectInfo expires(Long expires) {
   ...
   /**
   * Expiration date of the file in UNIX epoch milliseconds.
   * @return expires
  **/
  @ApiModelProperty(required = true, value = "Expiration date of the file in UNIX epoch milliseconds.")
  ...
  public ObjectInfo versionId(String versionId) {
   ...
   * @return versionId
  **/
  @ApiModelProperty(required = true, value = "Version ID of the file.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.etag, objectInfo.etag) &&
        Objects.equals(this.name, objectInfo.name) &&
        Objects.equals(this.lastModified, objectInfo.lastModified) &&
        Objects.equals(this.size, objectInfo.size) &&
        Objects.equals(this.contentType, objectInfo.contentType) &&
        Objects.equals(this.expires, objectInfo.expires) &&
        Objects.equals(this.versionId, objectInfo.versionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(etag, name, lastModified, size, contentType, expires, versionId);
  }
