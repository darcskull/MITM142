...
/**
 * Object representing a from-to range in SQL storage format. Used in multi-index storage. For strings lexographical comparison is used. For floats and integers standard comparison. 
 */
@ApiModel(description = "Object representing a from-to range in SQL storage format. Used in multi-index storage. For strings lexographical comparison is used. For floats and integers standard comparison. ")
...
public class Range {
  ...
  private List<Column> low = new ArrayList<Column>();

  public static final String SERIALIZED_NAME_HIGH = "high";
  @SerializedName(SERIALIZED_NAME_HIGH)
  private List<Column> high = new ArrayList<Column>();


  public Range low(List<Column> low) {
    
    this.low = low;
    return this;
  }

  public Range addLowItem(Column lowItem) {
   ...
   * @return low
  **/
  @ApiModelProperty(required = true, value = "Lower bound of the range.")

  public List<Column> getLow() {
    return low;
  }


  public void setLow(List<Column> low) {
    this.low = low;
  }


  public Range high(List<Column> high) {
    
    this.high = high;
    return this;
  }

  public Range addHighItem(Column highItem) {
   ...
   * @return high
  **/
  @ApiModelProperty(required = true, value = "Upper bound of the range.")

  public List<Column> getHigh() {
    return high;
  }


  public void setHigh(List<Column> high) {
    this.high = high;
  }
