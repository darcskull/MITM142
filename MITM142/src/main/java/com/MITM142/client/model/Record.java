...
/**
 * Object representing a database record consisting of multiple columns and payload in SQL storage format. Used in multi-index storage.   
 */
@ApiModel(description = "Object representing a database record consisting of multiple columns and payload in SQL storage format. Used in multi-index storage.   ")
...
public class Record {
  ...
  public Record addColumnsItem(Column columnsItem) {
   ...
   /**
   * Columns used for indexing of the record.
   * @return columns
  **/
  @ApiModelProperty(required = true, value = "Columns used for indexing of the record.")
  ...
  public Record payload(String payload) {
   ...
   /**
   * Stored data indexed up to its correspoding columns.
   * @return payload
  **/
  @ApiModelProperty(required = true, value = "Stored data indexed up to its correspoding columns.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columns, record.columns) &&
        Objects.equals(this.payload, record.payload);
  }

  @Override
  public int hashCode() {
    return Objects.hash(columns, payload);
  }
