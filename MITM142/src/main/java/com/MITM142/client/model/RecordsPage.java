...
/**
 * Object representing a list of records in SQL storage format. Used in multi-index storage. Responses returned for given range are in this format. 
 */
@ApiModel(description = "Object representing a list of records in SQL storage format. Used in multi-index storage. Responses returned for given range are in this format. ")
...
public class RecordsPage {
  ...
  public RecordsPage records(List<Record> records) {
    
    this.records = records;
    return this;
  }

  public RecordsPage addRecordsItem(Record recordsItem) {
    this.records.add(recordsItem);
    return this;
  }

   /**
   * Array of the returned records.
   * @return records
  **/
  @ApiModelProperty(required = true, value = "Array of the returned records.")
  ...
  public RecordsPage hasMore(Boolean hasMore) {
   ...
   /**
   * Flag indicating whether there are more records for the quered range.
   * @return hasMore
  **/
  @ApiModelProperty(required = true, value = "Flag indicating whether there are more records for the quered range.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.records, recordsPage.records) &&
        Objects.equals(this.hasMore, recordsPage.hasMore);
  }

  @Override
  public int hashCode() {
    return Objects.hash(records, hasMore);
  }
