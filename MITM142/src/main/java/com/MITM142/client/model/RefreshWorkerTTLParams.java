...
/**
 * Object used for storing request data for refreshing worker&#39;s ttl. 
 */
@ApiModel(description = "Object used for storing request data for refreshing worker's ttl. ")
...
public class RefreshWorkerTTLParams {
  public static final String SERIALIZED_NAME_WORKERID = "workerid";
  @SerializedName(SERIALIZED_NAME_WORKERID)
  ...
  public RefreshWorkerTTLParams workerid(String workerid) {
   ...
   * @return workerid
  **/
  @ApiModelProperty(required = true, value = "Id of the worker.")
  ...
  public RefreshWorkerTTLParams shard(Long shard) {
   ...
   /**
   * Shard for which the worker was assigned.
   * @return shard
  **/
  @ApiModelProperty(required = true, value = "Shard for which the worker was assigned.")
  ...
  public boolean equals(Object o) {
    ...
    RefreshWorkerTTLParams refreshWorkerTTLParams = (RefreshWorkerTTLParams) o;
    return Objects.equals(this.workerid, refreshWorkerTTLParams.workerid) &&
        Objects.equals(this.shard, refreshWorkerTTLParams.shard);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workerid, shard);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RefreshWorkerTTLParams {\n");
