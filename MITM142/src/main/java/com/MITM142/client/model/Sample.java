...
/**
 * Object representing sample for storing timeseries. Used in timeseries storage. 
 */
@ApiModel(description = "Object representing sample for storing timeseries. Used in timeseries storage. ")
...
public class Sample {
   ...
   * @return timestamp
  **/
  @ApiModelProperty(required = true, value = "Timestamp in UNIX epoch milliseconds.")
  ...
  public Sample value(Double value) {
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "Value of the sample.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timestamp, sample.timestamp) &&
