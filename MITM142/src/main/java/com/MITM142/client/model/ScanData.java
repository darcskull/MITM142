...
/**
 * Object representing result of scan operation over keys, maps, sets or registries.
 */
@ApiModel(description = "Object representing result of scan operation over keys, maps, sets or registries.")
...
public class ScanData {
  ...
  public ScanData keys(List<String> keys) {
    
    this.keys = keys;
    return this;
  }

  public ScanData addKeysItem(String keysItem) {
    this.keys.add(keysItem);
    return this;
  }

   /**
   * List of fullkeys in the format {{table}}/{{key}}.
   * @return keys
  **/
  @ApiModelProperty(required = true, value = "List of fullkeys in the format {{table}}/{{key}}.")
  ...
  public ScanData cursor(Map<String, String> cursor) {
    
    this.cursor = cursor;
    return this;
  }

  public ScanData putCursorItem(String key, String cursorItem) {
    this.cursor.put(key, cursorItem);
    return this;
  }

   /**
   * Iteration cursor. Must stop iteration when length of the cursor is 0.
   * @return cursor
  **/
  @ApiModelProperty(required = true, value = "Iteration cursor. Must stop iteration when length of the cursor is 0.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keys, scanData.keys) &&
        Objects.equals(this.cursor, scanData.cursor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keys, cursor);
  }
