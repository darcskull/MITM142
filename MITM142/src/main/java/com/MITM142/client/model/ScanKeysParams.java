...
public class ScanKeysParams {
  ...
  private Map<String, String> cursor = new HashMap<String, String>();
  ...
  public ScanKeysParams table(String table) {
   ...
   * @return table
  **/
  @ApiModelProperty(required = true, value = "Table to search for.")
  ...
  public ScanKeysParams pattern(String pattern) {
   ...
   /**
   * Pattern to search for. Could use regex like expressions such as \&quot;key*\&quot;.
   * @return pattern
  **/
  @ApiModelProperty(required = true, value = "Pattern to search for. Could use regex like expressions such as \"key*\".")
  ...
  public ScanKeysParams cursor(Map<String, String> cursor) {
    
    this.cursor = cursor;
    return this;
  }

  public ScanKeysParams putCursorItem(String key, String cursorItem) {
    this.cursor.put(key, cursorItem);
    return this;
  }

   /**
   * Cursor for next iteration. Stop when empty.
   * @return cursor
  **/
  @ApiModelProperty(required = true, value = "Cursor for next iteration. Stop when empty.")
  ...
  public void setCursor(Map<String, String> cursor) {
    this.cursor = cursor;
  }


  public ScanKeysParams count(Long count) {
   ...
   /**
   * Count of elements to return during the next iteration.
   * @return count
  **/
  @ApiModelProperty(required = true, value = "Count of elements to return during the next iteration.")
  ...
  public boolean equals(Object o) {
    ...
    ScanKeysParams scanKeysParams = (ScanKeysParams) o;
    return Objects.equals(this.table, scanKeysParams.table) &&
        Objects.equals(this.pattern, scanKeysParams.pattern) &&
        Objects.equals(this.cursor, scanKeysParams.cursor) &&
        Objects.equals(this.count, scanKeysParams.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, pattern, cursor, count);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScanKeysParams {\n");
