...
/**
 * Object representing a database schema consisting of multiple columns in SQL storage format. Used in multi-index storage. Column values are discarded during usage.  
 */
@ApiModel(description = "Object representing a database schema consisting of multiple columns in SQL storage format. Used in multi-index storage. Column values are discarded during usage.  ")
...
public class Schema {
  ...
  public Schema columns(List<Column> columns) {
    
    this.columns = columns;
    return this;
  }

  public Schema addColumnsItem(Column columnsItem) {
    this.columns.add(columnsItem);
    return this;
  }

   /**
   * Columns supported by the schema.
   * @return columns
  **/
  @ApiModelProperty(required = true, value = "Columns supported by the schema.")
