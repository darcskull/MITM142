...
/**
 * Object used for query storage indices in different modes. Used by the full text search storage. 
 */
@ApiModel(description = "Object used for query storage indices in different modes. Used by the full text search storage. ")
...
public class SearchQuery {
   ...
   * @return query
  **/
  @ApiModelProperty(required = true, value = "Query to search for.")
  ...
  public SearchQuery searchType(String searchType) {
   ...
   /**
   * Type of the search query. Supported types are - \&quot;bm25\&quot;, \&quot;regex\&quot; and \&quot;phrases\&quot;. In \&quot;bm25\&quot; mode, storage will find all relevant documents for given keywords. In \&quot;regex\&quot; mode storage will find all documents results with keywords matching the regex. In \&quot;phrase\&quot; mode storage will match all the stored phrases to given regex and after that evaluate the phrases using bm25 algorithm eg. this way phrase searches of the type \&quot;software*\&quot; are enabled.
   * @return searchType
  **/
  @ApiModelProperty(required = true, value = "Type of the search query. Supported types are - \"bm25\", \"regex\" and \"phrases\". In \"bm25\" mode, storage will find all relevant documents for given keywords. In \"regex\" mode storage will find all documents results with keywords matching the regex. In \"phrase\" mode storage will match all the stored phrases to given regex and after that evaluate the phrases using bm25 algorithm eg. this way phrase searches of the type \"software*\" are enabled.")
  ...
  **/
  ...
  public SearchQuery offset(Long offset) {
   ...
   * @return offset
  **/
  @ApiModelProperty(required = true, value = "Offset of next records page in the iteration cycle.")
  ...
  public SearchQuery limit(Long limit) {
   ...
   /**
   * How many results to return on next iteration.
   * @return limit
  **/
  @ApiModelProperty(required = true, value = "How many results to return on next iteration.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.query, searchQuery.query) &&
        Objects.equals(this.searchType, searchQuery.searchType) &&
        Objects.equals(this.language, searchQuery.language) &&
        Objects.equals(this.offset, searchQuery.offset) &&
        Objects.equals(this.limit, searchQuery.limit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(query, searchType, language, offset, limit);
  }
