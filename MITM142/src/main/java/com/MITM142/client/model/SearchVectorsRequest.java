...
public class SearchVectorsRequest {
  ...
  public SearchVectorsRequest vector(Vector vector) {
  ...
  **/
  ...
  public SearchVectorsRequest k(Long k) {
   ...
   /**
   * Number of vector neighbours to find.
   * @return k
  **/
  @ApiModelProperty(required = true, value = "Number of vector neighbours to find.")
  ...
  public boolean equals(Object o) {
    ...
    SearchVectorsRequest searchVectorsRequest = (SearchVectorsRequest) o;
    return Objects.equals(this.vector, searchVectorsRequest.vector) &&
        Objects.equals(this.k, searchVectorsRequest.k);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vector, k);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchVectorsRequest {\n");
