...
public class SetKeyParams {
  ...
  public SetKeyParams table(String table) {
   ...
   * @return table
  **/
  @ApiModelProperty(required = true, value = "Table where to store data.")
  ...
  public SetKeyParams key(String key) {
   ...
   /**
   * Correspoding key for storing data.
   * @return key
  **/
  @ApiModelProperty(required = true, value = "Correspoding key for storing data.")
  ...
  public SetKeyParams value(String value) {
  ...
  **/
  ...
  public SetKeyParams duration(Long duration) {
   ...
   /**
   * TTL in Golang time.Duration format eg. 10 * time.Seconds.
   * @return duration
  **/
  @ApiModelProperty(required = true, value = "TTL in Golang time.Duration format eg. 10 * time.Seconds.")
  ...
  public boolean equals(Object o) {
    ...
    SetKeyParams setKeyParams = (SetKeyParams) o;
    return Objects.equals(this.table, setKeyParams.table) &&
        Objects.equals(this.key, setKeyParams.key) &&
        Objects.equals(this.value, setKeyParams.value) &&
        Objects.equals(this.duration, setKeyParams.duration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, key, value, duration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetKeyParams {\n");
