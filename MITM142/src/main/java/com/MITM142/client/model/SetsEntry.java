...
/**
 * Object representing a sorted set entry in NoSQL storage. {{key}} {{score}} --&gt; {{value}} equivivalent is {{table}}/{{key}} {{score}} --&gt; {{value}}     
 */
@ApiModel(description = "Object representing a sorted set entry in NoSQL storage. {{key}} {{score}} --> {{value}} equivivalent is {{table}}/{{key}} {{score}} --> {{value}}     ")
...
public class SetsEntry {
  ...
  public SetsEntry table(String table) {
  ...
  **/
  ...
  public SetsEntry key(String key) {
  ...
  **/
  ...
  public SetsEntry score(Long score) {
   ...
   * @return score
  **/
  @ApiModelProperty(required = true, value = "Score of the entry.")
  ...
  public SetsEntry value(String value) {
  ...
  **/
  ...
  public SetsEntry deleted(Boolean deleted) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SetsEntry setsEntry = (SetsEntry) o;
    return Objects.equals(this.table, setsEntry.table) &&
        Objects.equals(this.key, setsEntry.key) &&
        Objects.equals(this.score, setsEntry.score) &&
        Objects.equals(this.value, setsEntry.value) &&
        Objects.equals(this.deleted, setsEntry.deleted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, key, score, value, deleted);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetsEntry {\n");
