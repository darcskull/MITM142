...
/**
 * Object representing configuration data for storing timeseries. Used in timeseries storage. 
 */
@ApiModel(description = "Object representing configuration data for storing timeseries. Used in timeseries storage. ")
...
public class TimeSeriesConfiguration {
  public static final String SERIALIZED_NAME_BUCKET_SIZE_PERIOD = "bucketSizePeriod";
  @SerializedName(SERIALIZED_NAME_BUCKET_SIZE_PERIOD)
  private Long bucketSizePeriod;
  ...
  private Long retentionInterval;


  public TimeSeriesConfiguration bucketSizePeriod(Long bucketSizePeriod) {
    
    this.bucketSizePeriod = bucketSizePeriod;
    return this;
  }

   /**
   * Configuration field used to compact timeseries values to buckets with bucketSizePeriod size.
   * @return bucketSizePeriod
  **/
  @ApiModelProperty(required = true, value = "Configuration field used to compact timeseries values to buckets with bucketSizePeriod size.")

  public Long getBucketSizePeriod() {
    return bucketSizePeriod;
  }


  public void setBucketSizePeriod(Long bucketSizePeriod) {
    this.bucketSizePeriod = bucketSizePeriod;
  }


  public TimeSeriesConfiguration retentionPeriod(Long retentionPeriod) {
   ...
   /**
   * How far in the past to keep the values. In UNIX epoch milliseconds format.
   * @return retentionPeriod
  **/
  @ApiModelProperty(required = true, value = "How far in the past to keep the values. In UNIX epoch milliseconds format.")
  ...
  public TimeSeriesConfiguration retentionInterval(Long retentionInterval) {
   ...
   /**
   * How often to run retention. In UNIX epoch milliseconds format.
   * @return retentionInterval
  **/
  @ApiModelProperty(required = true, value = "How often to run retention. In UNIX epoch milliseconds format.")
  ...
  public void setRetentionInterval(Long retentionInterval) {
    this.retentionInterval = retentionInterval;
  }
  ...
  public boolean equals(Object o) {
    ...
    TimeSeriesConfiguration timeSeriesConfiguration = (TimeSeriesConfiguration) o;
    return Objects.equals(this.bucketSizePeriod, timeSeriesConfiguration.bucketSizePeriod) &&
        Objects.equals(this.retentionPeriod, timeSeriesConfiguration.retentionPeriod) &&
        Objects.equals(this.retentionInterval, timeSeriesConfiguration.retentionInterval);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bucketSizePeriod, retentionPeriod, retentionInterval);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimeSeriesConfiguration {\n");
    sb.append("    bucketSizePeriod: ").append(toIndentedString(bucketSizePeriod)).append("\n");
