...
/**
 * Object representing multiple samples and their labels. Used in timeseries storage. 
 */
@ApiModel(description = "Object representing multiple samples and their labels. Used in timeseries storage. ")
...
public class TimeSeriesEntry {
  ...
  public TimeSeriesEntry metric(String metric) {
   ...
   * @return metric
  **/
  @ApiModelProperty(required = true, value = "Metric of the entry.")
  ...
  public TimeSeriesEntry labels(List<Label> labels) {
    
    this.labels = labels;
    return this;
  }

  public TimeSeriesEntry addLabelsItem(Label labelsItem) {
   ...
   * @return labels
  **/
  @ApiModelProperty(required = true, value = "Array of labels.")
  ...
  public TimeSeriesEntry samples(List<Sample> samples) {
    
    this.samples = samples;
    return this;
  }

  public TimeSeriesEntry addSamplesItem(Sample samplesItem) {
    this.samples.add(samplesItem);
    return this;
  }

   /**
   * Array of samples, correspoding to the labels in the format labels[i] --&gt; samles[i].
   * @return samples
  **/
  @ApiModelProperty(required = true, value = "Array of samples, correspoding to the labels in the format labels[i] --> samles[i].")
  ...
  public boolean equals(Object o) {
    ...
    TimeSeriesEntry timeSeriesEntry = (TimeSeriesEntry) o;
    return Objects.equals(this.metric, timeSeriesEntry.metric) &&
        Objects.equals(this.labels, timeSeriesEntry.labels) &&
        Objects.equals(this.samples, timeSeriesEntry.samples);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metric, labels, samples);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimeSeriesEntry {\n");
