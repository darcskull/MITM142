...
/**
 * Object used for filtering timeseries entries for given timestamp range. Used in timeseries storage. 
 */
@ApiModel(description = "Object used for filtering timeseries entries for given timestamp range. Used in timeseries storage. ")
...
public class TimeSeriesRange {
  public static final String SERIALIZED_NAME_METRIC_MATCHER = "metricMatcher";
  @SerializedName(SERIALIZED_NAME_METRIC_MATCHER)
  private Matcher metricMatcher;
  ...
  public static final String SERIALIZED_NAME_LABEL_MATCHERS = "labelMatchers";
  @SerializedName(SERIALIZED_NAME_LABEL_MATCHERS)
  private List<Matcher> labelMatchers = null;


  public TimeSeriesRange metricMatcher(Matcher metricMatcher) {
  ...
  **/
  ...
  public Matcher getMetricMatcher() {
    return metricMatcher;
  }


  public void setMetricMatcher(Matcher metricMatcher) {
    this.metricMatcher = metricMatcher;
  }


  public TimeSeriesRange from(Long from) {
   ...
   /**
   * Start of the time range in UNIX epoch milliseconds.
   * @return from
  **/
  @ApiModelProperty(required = true, value = "Start of the time range in UNIX epoch milliseconds.")
  ...
  public TimeSeriesRange to(Long to) {
   ...
   /**
   * End of the time range in UNIX epoch milliseconds.
   * @return to
  **/
  @ApiModelProperty(required = true, value = "End of the time range in UNIX epoch milliseconds.")
  ...
  public TimeSeriesRange labelMatchers(List<Matcher> labelMatchers) {
    
    this.labelMatchers = labelMatchers;
    return this;
  }

  public TimeSeriesRange addLabelMatchersItem(Matcher labelMatchersItem) {
    if (this.labelMatchers == null) {
      this.labelMatchers = new ArrayList<Matcher>();
    }
   ...
   /**
   * Array of matchers used to match by labels.
   * @return labelMatchers
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of matchers used to match by labels.")

  public List<Matcher> getLabelMatchers() {
    return labelMatchers;
  }


  public void setLabelMatchers(List<Matcher> labelMatchers) {
    this.labelMatchers = labelMatchers;
  }
  ...
  public boolean equals(Object o) {
    ...
    TimeSeriesRange timeSeriesRange = (TimeSeriesRange) o;
    return Objects.equals(this.metricMatcher, timeSeriesRange.metricMatcher) &&
        Objects.equals(this.from, timeSeriesRange.from) &&
        Objects.equals(this.to, timeSeriesRange.to) &&
        Objects.equals(this.labelMatchers, timeSeriesRange.labelMatchers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metricMatcher, from, to, labelMatchers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimeSeriesRange {\n");
    sb.append("    metricMatcher: ").append(toIndentedString(metricMatcher)).append("\n");
