...
/**
 * Object representing a vector with its coordinates, id and distance. Used in vectors insert and search API.  
 */
@ApiModel(description = "Object representing a vector with its coordinates, id and distance. Used in vectors insert and search API.  ")
...
public class Vector {
  ...
  public static final String SERIALIZED_NAME_VECTORID = "vectorid";
  @SerializedName(SERIALIZED_NAME_VECTORID)
  ...
  public Vector coordinates(List<Float> coordinates) {
    
    this.coordinates = coordinates;
    return this;
  }

  public Vector addCoordinatesItem(Float coordinatesItem) {
    this.coordinates.add(coordinatesItem);
    return this;
  }

   /**
   * Array of float32 values each representing a coordinate.
   * @return coordinates
  **/
  @ApiModelProperty(required = true, value = "Array of float32 values each representing a coordinate.")
  ...
  public Vector vectorid(Long vectorid) {
   ...
   * @return vectorid
  **/
  @ApiModelProperty(required = true, value = "Unique ID of the vector.")
  ...
  public Vector distance(Float distance) {
   ...
   /**
   * Used in search vectors functionaliy. Stores the distance to the vector searched.
   * @return distance
  **/
  @ApiModelProperty(required = true, value = "Used in search vectors functionaliy. Stores the distance to the vector searched.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.coordinates, vector.coordinates) &&
        Objects.equals(this.vectorid, vector.vectorid) &&
        Objects.equals(this.distance, vector.distance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(coordinates, vectorid, distance);
  }
