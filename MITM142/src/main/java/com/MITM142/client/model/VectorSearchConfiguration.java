...
/**
 * Object representing configuration data for storing vectors. Used in vector search. 
 */
@ApiModel(description = "Object representing configuration data for storing vectors. Used in vector search. ")
...
public class VectorSearchConfiguration {
  ...
  public static final String SERIALIZED_NAME_MAX_ELEMENTS_PER_BUCKET = "maxElementsPerBucket";
  @SerializedName(SERIALIZED_NAME_MAX_ELEMENTS_PER_BUCKET)
  private Long maxElementsPerBucket;

  public static final String SERIALIZED_NAME_MAXIMUM_ENCODED_VECTOR_LEN = "maximumEncodedVectorLen";
  @SerializedName(SERIALIZED_NAME_MAXIMUM_ENCODED_VECTOR_LEN)
  private Long maximumEncodedVectorLen;


  public VectorSearchConfiguration shards(Long shards) {
   ...
   /**
   * Number of shards in which the vector space is divided.
   * @return shards
  **/
  @ApiModelProperty(required = true, value = "Number of shards in which the vector space is divided.")
  ...
  public VectorSearchConfiguration maxElementsPerBucket(Long maxElementsPerBucket) {
    
    this.maxElementsPerBucket = maxElementsPerBucket;
    return this;
  }

   /**
   * How many elements to store in each bucket.
   * @return maxElementsPerBucket
  **/
  @ApiModelProperty(required = true, value = "How many elements to store in each bucket.")

  public Long getMaxElementsPerBucket() {
    return maxElementsPerBucket;
  }


  public void setMaxElementsPerBucket(Long maxElementsPerBucket) {
    this.maxElementsPerBucket = maxElementsPerBucket;
  }


  public VectorSearchConfiguration maximumEncodedVectorLen(Long maximumEncodedVectorLen) {
    
    this.maximumEncodedVectorLen = maximumEncodedVectorLen;
    return this;
  }

   /**
   * How much is the maximum len of a single vector encoded into the parquet format. Used to size the buckets and optimize the read and write operations.
   * @return maximumEncodedVectorLen
  **/
  @ApiModelProperty(required = true, value = "How much is the maximum len of a single vector encoded into the parquet format. Used to size the buckets and optimize the read and write operations.")

  public Long getMaximumEncodedVectorLen() {
    return maximumEncodedVectorLen;
  }


  public void setMaximumEncodedVectorLen(Long maximumEncodedVectorLen) {
    this.maximumEncodedVectorLen = maximumEncodedVectorLen;
  }
  ...
  public boolean equals(Object o) {
    ...
    VectorSearchConfiguration vectorSearchConfiguration = (VectorSearchConfiguration) o;
    return Objects.equals(this.shards, vectorSearchConfiguration.shards) &&
        Objects.equals(this.maxElementsPerBucket, vectorSearchConfiguration.maxElementsPerBucket) &&
        Objects.equals(this.maximumEncodedVectorLen, vectorSearchConfiguration.maximumEncodedVectorLen);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shards, maxElementsPerBucket, maximumEncodedVectorLen);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VectorSearchConfiguration {\n");
    sb.append("    shards: ").append(toIndentedString(shards)).append("\n");
    sb.append("    maxElementsPerBucket: ").append(toIndentedString(maxElementsPerBucket)).append("\n");
    sb.append("    maximumEncodedVectorLen: ").append(toIndentedString(maximumEncodedVectorLen)).append("\n");
    sb.append("}");
    return sb.toString();
  }
